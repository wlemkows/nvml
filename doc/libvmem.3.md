...
basics API functions are expanded to UTF-8 API with postfix *U*,
...
the libraries under !ifdef{WIN32}{**\<project_location\>\\nvml\\src\\x64\\Debug**}{**/usr/lib/nvml_debug**}, contains
run-time assertions and trace points. The typical way to
access the debug version is to set the environment variable
**LD_LIBRARY_PATH** to !ifdef{WIN32}{**\<project_location\>\\nvml\\src\\x64\\Debug** or other location}
